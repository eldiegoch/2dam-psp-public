...
public class Servidor {
	...
	public static void main(String[] args) throws InterruptedException, ClassNotFoundException {
		try {
			...
			System.out.println(
					"SERVIDOR: Creando socket servidor y realizando el bind en el puerto: " + puertoEscuchaConexiones);
			...
			System.out.println(
					"SERVIDOR: Aceptando conexiones. El servidor se bloquea esperando conexiones entrantes \n");
			...
			while (contadorPeticiones < MAX_PETICIONES) {
				...
				System.out.println(
						"SERVIDOR: Conexión recibida. El framework nos devuelve un nuevo socket para 'dialogar'. El puerto de este nuevo socket es: "
								+ newSocket.getPort());
				...
				hiloCom.start();
				System.out.println(
						"Quedan " + (MAX_PETICIONES - contadorPeticiones) + " peticiones para terminar el server");
			}
	...
	/**
	 * Obtiene los milisegundos que serían después de numMinutosDespues. Se calcula
	 * el instante actual en milisegundos, y se le suma 2 minutos en esa misma
	 * unidad.
	 * 
	 * @param numMinutosDespues Parametro para indicar cuántos minutos después se
	 *                          quiere los milisegundos, a partir del actual
